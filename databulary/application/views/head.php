...
<section >
	<div id="main" style="margin-left: 10px;margin-right: 10px; margin-top: 10px; width: auto;">
		<form action="http://localhost/pwl/ta/databulary/index.php/dabul/search/" method="get">

			
			<input type="text" id="search" class="form-control"  style="width: 80%;position: absolute;" name="value">
			<input type="submit" class="form-control" style="width: 20%;position: absolute;" value="Search" >
		</form>
	</div>
