...
html	{
	background: #f8f4e8 url("https://4.bp.blogspot.com/-ze-ynwyxn6E/We8nM63Tt3I/AAAAAAAAAi8/FSvRfgFRHXII4X8NJ_ZXTnpEXN4aMeMqgCK4BGAYYCw/s400/bg_tile.jpg") left top repeat;
}
...
<section >
	<!-- <div id="main" style="margin-left: 10px;margin-right: 10px; margin-top: 10px; width: auto;">
		<form action="<?php echo base_url('/index.php/dabul/search');?>">
	...
	<?php 
		if (isset($eng)) {
			echo '<div id="main2" ><center><judul>'.$eng.'</judul></center></div>';
			if (isset($irr)) {
				echo "<div style='text-align: center;'>";
				echo '<div id="main3" ><center><judul>'.$irr["v1"].'</judul></center></div>';
				echo '<div id="main3" ><center><judul>'.$irr["v2"].'</judul></center></div>';
				echo '<div id="main3" ><center><judul>'.$irr["v3"].'</judul></center></div>';
				echo "</div>";
			}
			echo '<div id="main2" >'.$ind.'</div>';
		}
		echo '<div id="main2" >';
		...
		foreach ($para as $div) {
			if (strlen($div)>10 && !strpos($div, 'may refer to:')) {
				echo '<div id="main2" >';
				echo $div."<br/>";
				echo '</div>';
			}
	...
	<p>The database of words!	</p></center>
</section>

<!--wrapper-->


<!-- <img src="http://ponselterupdate.com/wp-content/uploads/2017/01/Gambar-DP-BBM-Kata-Mutiara-Bijak.png"> -->
